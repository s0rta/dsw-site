...

{
  ...
  'Healthtech' => {
    description: "Healthcare costs continue to rise, putting individuals and companies in an economically unstable situation. Enter digital health technologies, exploding on to the scene with engaging, low-cost, and convenient tools that will have a lasting impact on large populations both here in Colorado and throughout the country.\n\nExplore the significant transformations coming to, and already being implemented in, the healthcare industry from both technologists and healthcare professionals. Plus, see the technological innovations that could be making a real difference to your health care in the near future.The collision of the worlds of healthcare and technology is affording many unique opportunities to have a lasting impact on a large number of people. Explore the applications of technology within the healthcare space from the perspectives of both technologists and healthcare professionals, and see the ways in which technological innovations are making a real difference."
  }
