...
RSpec.describe PitchContest::Entry, type: :model do
  ...
  it { is_expected.to allow_value('youtube.com/watch?v=EK7J_ZzvF8k').for(:video_url) }
  it { is_expected.to allow_value('http://youtube.com/watch?v=EK7J_ZzvF8k').for(:video_url) }
  it { is_expected.to allow_value('https://youtube.com/watch?v=EK7J_ZzvF8k').for(:video_url) }
  it { is_expected.not_to allow_value('yotube.com/watch?v=EK7J_ZzvF8k').for(:video_url) }
