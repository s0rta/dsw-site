class Givetoo::IdeasController < ApplicationController
  respond_to :html
  ...
  def new
    @idea = current_user.givetoo_ideas.build
  end

  def create
    @idea = current_user.ideas.new(idea_params)
    if @idea.save
      flash[:notice] = "Thanks! Your submission has been received and you will receive an e-mail confirmation shortly"
